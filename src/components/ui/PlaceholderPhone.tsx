...
export function PlaceholderPhone({ appName, accentColor, screenshot }: PlaceholderPhoneProps) {
  return (
    <div className="relative w-[180px] h-[380px] md:w-[200px] md:h-[420px] rounded-[2.2rem] border-2 border-surface-500 bg-surface-800 overflow-hidden shrink-0 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
      {/* Dynamic island — only for placeholder */}
      {!screenshot && (
      ...
      {/* Home indicator — only for placeholder */}
      {!screenshot && (
